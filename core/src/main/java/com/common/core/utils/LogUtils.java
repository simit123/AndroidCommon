...
public class LogUtils implements Thread.UncaughtExceptionHandler {
     ...
     * @return LogUtils
     */
    public LogUtils isOpen(boolean isOpen) {
     ...
     * @return LogUtils
     */
    public LogUtils isSave(boolean isSave) {
     ...
     * @return  LogUtils
     */
    public LogUtils setLogPath(String logPath) {
     ...
     * @return  LogUtils
     */
    public LogUtils setLogName(String logName) {
        LogUtils.logName = logName;
        return this;
    }
